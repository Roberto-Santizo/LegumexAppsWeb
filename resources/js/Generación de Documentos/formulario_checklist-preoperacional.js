...
(function () {
    ...
    const plantaId = document.getElementById('planta_id').value;

    if (documentocp && plantaId) {
        var url = window.location.href;
        var urlObj = new URL(url);
        var windowWidth = plantaId == 2 ? 6144 : 4160;
        var windowHeight = plantaId == 2 ? 2950.40 : 2000;
        var options = {
