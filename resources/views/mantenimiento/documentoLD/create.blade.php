...
@section('titulo')
    Creación documento de lavado y desinfección de herramientas
@endsection
...
@section('contenido')
    ...
    <div class="bg-white p-6 rounded-lg shadow-lg mt-10 md:mt-0 container xl:w-2/3  mx-auto">
        <x-alertas />
        <form action="{{ route('documentold.store') }}" method="POST" id="formulario1" novalidate class="space-y-5">
            @csrf
            ...
            <fieldset class="border p-10">
                <legend class="text-sm md:text-2xl font-bold py-5">Herramientas que se estan ingresando</legend>
            ...
            <fieldset class="mt-5 space-y-5 border p-10 shadow">
                <legend class="font-bold text-2xl">Inspección de calidad</legend>
                ...
                <x-input type="text" name="observaciones_entrada" label="Observaciones de Entrada"
                    placeholder="Observación de entrada de Herramientas" />
                ...
                <div class="flex flex-col items-center 2xl:flex-row justify-center gap-2 text-center">
                    <div class="space-y-5">
                        ...
                        <div class="clear_btn space-y-5">
                            <h4 class="text-xl font-bold">Firma Inspector de calidad</h4>
                            <div id="clear-button-2" class=" btn bg-orange-600 hover:bg-orange-800">
                                <span>Limpiar</span>
                            </div>
                        </div>
                    </div>
            ...
            <fieldset class="mt-5 space-y-5 border p-10 shadow">
                <legend class="font-bold text-2xl">Mantenimiento</legend>
                ...
                <div class="flex flex-col items-center 2xl:flex-row justify-center gap-2 text-center">
                    <div class="space-y-5">
                        ...
                        <div class="clear_btn space-y-5">
                            ...
                            <div id="clear-button" class=" btn bg-orange-600 hover:bg-orange-800">
                                <span>Limpiar</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-5">
                        ...
                        <div class="space-y-5">
                            ...
                            <div id="clear-button-3" class=" btn bg-orange-600 hover:bg-orange-800">
                                <span>Limpiar</span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="flex justify-end mt-20">
                <input type="submit" value="Guardar Borrador" class=" btn bg-orange-600 hover:bg-orange-800">
            </div>
        </form>
    </div>
@endsection
