        ...
        <div class="flex gap-5 p-5">
            <div class="flex flex-col justify-center w-1/2">
                <div class="mb-5 flex flex-col ">
                    ...
                    <textarea class="border border-black" name="trabajo_realizado" id="trabajo_realizado" cols="30" rows="5">{{ ($ot->trabajo_realizado) ? $ot->trabajo_realizado : '' }}</textarea>
                ...
                <div class="mb-5 flex flex-col">
                    ...
                    <textarea class="border border-black" name="repuestos_utilizados" id="repuestos_utilizados" cols="30" rows="5">{{ ($ot->repuestos_utilizados) ? $ot->repuestos_utilizados : '' }}</textarea>
            ...
            <div class="flex gap-10">
                <div class="mb-5 flex flex-col">
                    ...
                    <input type="time" name="hora_inicio" id="hora_inicio" class="border border-black p-2 rounded" placeholder="Nombre del jefe de mantenimiento">
                    @error('hora_inicio')
                        <p class="bg-red-500 text-white my-2 rounded-lg text-sm p-2 text-center">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mb-5 flex flex-col">
                    ...
                    <input type="time" name="hora_final" id="hora_final" class="border border-black p-2 rounded" placeholder="Nombre del jefe de mantenimiento">
                    @error('hora_final')
                        <p class="bg-red-500 text-white my-2 rounded-lg text-sm p-2 text-center">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class=" p-3 shadow-lg rounded">
                <div class="mb-5 flex flex-col">
                    ...
                    <input type="text" name="nombre_mecanico" id="nombre_mecanico" class="border border-black p-2 rounded" disabled placeholder="{{ $ot->usuario->name }}">
                ...
                <div class="mb-5 flex flex-col">
                    ...
                    <input type="text" name="fecha_entrega" disabled id="fecha_entrega" class="border border-black p-2 rounded" value="{{now()->format('d-m-Y') }}">
                    @error('fecha_entrega')
                        <p class="bg-red-500 text-white my-2 rounded-lg text-sm p-2 text-center">{{ $message }}</p>
                    @enderror
                ...
                <div class="flex flex-col justify-center items-center">
                    ...
                    <div class="clear_btn flex flex-col items-center">
                        ...
                        <div id="clear-button-2" class="inline-block mt-5 bg-orange-600 hover:bg-orange-700 p-3 transition-colors cursor-pointer uppercase font-bold text-white rounded-lg"><span>Limpiar</span></div>
                    </div>
   ...
   <fieldset class="mt-5 border border-black flex justify-around">
        ...
        <div class=" p-3 shadow-lg rounded">
            ...
            <div class="mb-5 flex flex-col">
                ...
                <input type="text" disabled name="fecha_inspeccion_calidad" id="fecha_inspeccion_calidad" class="border border-black p-2 rounded" value="{{ now()->format('d-m-Y') }}">
