    ...
    <form wire:submit.prevent='crearTareaLoteExt' novalidate>
        ...
        <div class="mb-5">
            ...
            <select wire:model="plan_semanal_finca_id" name="plan_semanal_finca_id"
                class="w-full p-4 rounded bg-gray-50 select">
                <option value="" class="opcion-default" selected>---SELECCIONE UNA OPCIÓN---</option>
        ...
        <fieldset class="border p-5">
            ...
            <div class="w-full flex justify-end">
                <button wire:click='openModal()' type="button" class="btn bg-orange-500 hover:bg-orange-600">
            ...
            @else
                <p class="text-center text-2xl">Sin insumos</p>
            @endif
        </fieldset>
