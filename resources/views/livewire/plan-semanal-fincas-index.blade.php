        ...
        <tbody class="tabla-body">
            @forelse ($planes as $plansemanalfinca)
                <tr>
                    ...
                    <td class="campo"> <span
                            class="bg-sky-500 p-2 text-white rounded-xl">{{ $plansemanalfinca->tareasRealizadas->count() }}
                            / {{ $plansemanalfinca->tareasTotales->count() }}</span></td>
                    <td class="campo"> <span
                            class="bg-sky-500 p-2 text-white rounded-xl">{{ $plansemanalfinca->tareasCosechasTerminadas->count() }}
                            /
                    ...
                    <td class="campo text-center">
                        <a href="">
                            <i title="Reporte de Insumos Semanal"
                                class="fa-solid fa-file-arrow-down text-3xl hover:text-gray-500 cursor-pointer"></i>
                        </a>
                    </td>
                </tr>
