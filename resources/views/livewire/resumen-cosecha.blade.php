                ...
                <table class="tabla">
                    <thead class="bg-green-meadow">
                        <tr class="text-xs md:text-sm rounded uppercase">
                            ...
                            <th scope="col" class="text-white">Fecha de Incio de la Tarea</th>
                            <th scope="col" class="text-white">Fecha de Cierre de la Tarea</th>
                    ...
                    <tbody class="tabla-body text-black">
                        ...
                        <tr class="{{ ($asignacion->id === $asignacionSelected ? 'bg-gray-200' : '')  }} cursor-pointer hover:bg-gray-200"
                            ...
                            <td class="text-center"> {{ $asignacion->TotalHoras }} </p>
                            <td>
