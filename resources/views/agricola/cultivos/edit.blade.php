...
<div class="bg-white p-6 rounded-lg shadow-lg mt-10 md:mt-0 container xl:w-2/3  mx-auto">
    <form action="{{ route('cultivos.update',$cultivo) }}" method="POST" id="formulario7" novalidate>
        @csrf
        @method('PATCH')
        <x-alertas />
        ...
        <div class="mb-5">
            ...
            <input type="text" id="cultivo" name="cultivo"
                ...
                value="{{  $cultivo->cultivo }}" placeholder="Nombre/Codificación del Cultivo">
        ...
        <div class="mb-5">
            ...
            <input type="number" id="semanas" name="semanas"
                ...
                value="{{ $cultivo->semanas }}" placeholder="Semanas totales del cultivo">
